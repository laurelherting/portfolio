            ...
            <section id="about">
                <div className="row">
                    ...
                    <div className="ten columns main-col">
                        <h3>About Me</h3>
                        <p>
                            Passionate, diligent, results-driven, detailed, and articulate software developer with participation creating solid application architecture and coding. Passionate about problem-solving in order to understand abstact concepts through strong research skills resulting in innovative solutions.
                        </p>
                        <p>
